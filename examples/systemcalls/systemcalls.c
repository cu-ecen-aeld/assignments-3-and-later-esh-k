...
/**
 * @param outputfile - The full path to the file to write with command
 * output. This file will be closed at completion of the function call. All
 * other parameters, see do_exec above
 */
bool do_exec_redirect(const char *outputfile, int count, ...) {
     ...
     * https://stackoverflow.com/a/13784315/1446624 as a reference, redirect
     * standard out to a file specified by outputfile. The rest of the
